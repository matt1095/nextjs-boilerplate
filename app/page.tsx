    ...
    <main className="bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/60 bg-white/80 backdrop-blur">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            ...
            <a className="hover:text-slate-900 text-slate-500" href="/dashboard">Dashboard</a>
      ...
      <section className="relative overflow-hidden">
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 opacity-30">
          <div className="absolute -top-24 -left-24 w-80 h-80 rounded-full bg-indigo-400 blur-3xl" />
          <div className="absolute -bottom-24 -right-24 w-80 h-80 rounded-full bg-fuchsia-400 blur-3xl" />
        </div>

        <div className="mx-auto max-w-7xl px-6 pt-20 pb-12 md:pt-32 md:pb-20">
          <p className="text-xs font-semibold uppercase tracking-wider text-indigo-600">New — Reply to reviews in seconds</p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <a
              href={STRIPE_PRO}
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-xl px-5 py-3 ring-1 ring-slate-300 hover:bg-slate-50"
            >
        ...
        {/* Product demo (simple + clean) */}
        <div className="mx-auto max-w-6xl px-6 pb-8">
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
              <div className="text-sm font-semibold">Repute — Draft preview</div>
              <div className="flex items-center gap-3 text-xs">
                ...
                <select
                  ...
                  className="rounded-lg border border-slate-300 bg-transparent px-2 py-1 text-xs"
                >
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-5 md:p-6 border-b md:border-b-0 md:border-r border-slate-200">
                <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">Pasted review</p>
                <div className="mt-2 rounded-xl bg-slate-50 ring-1 ring-slate-200 p-4 text-sm">
                  “Food was great but we waited 35 minutes to be seated…”
                </div>
              </div>
              <div className="p-5 md:p-6">
                <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">Draft reply</p>
                <div className="mt-2 rounded-xl bg-slate-50 ring-1 ring-slate-200 p-4 text-sm min-h-[96px] whitespace-pre-wrap">
                  {demoReply}
                </div>
                <div className="mt-4">
                  <button
                    onClick={copyDemo}
                    className="inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm text-white bg-slate-900 hover:opacity-90"
                  >
                    {/* copy icon */}
          ...
          <p className="mt-3 text-xs text-slate-500">Demo only. The dashboard generates replies from full reviews.</p>
        </div>
      </section>
      ...
      <section id="how" className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={s.title} className="rounded-2xl border border-slate-200 p-6 bg-white">
      ...
      {/* ===== Features (minimal) ===== */}
      <section className="mx-auto max-w-7xl px-6 py-20 bg-slate-50">
      ...
      {/* ===== Pricing (7-day trial, monthly only) ===== */}
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-24">
        <div className="flex items-end justify-between gap-6 flex-wrap">
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold">Simple pricing</h2>
            <p className="mt-2 text-slate-600">Start free. Cancel anytime.</p>
          </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 p-6 bg-white">
            ...
            <p className="mt-2 text-sm text-slate-600">Single-location businesses.</p>
            <p className="mt-4 text-3xl font-extrabold">
              <span>$29</span><span className="text-base font-medium text-slate-500">/mo</span>
            </p>
          ...
          {/* Pro */}
          <div className="rounded-2xl border-2 border-indigo-500 p-6 bg-white">
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-600/10 text-indigo-700 px-3 py-1 text-xs font-semibold">
              Best value
            </div>
            <h3 className="mt-2 text-xl font-bold">Pro</h3>
            <p className="mt-2 text-sm text-slate-600">Growing teams & multi-location.</p>
            <p className="mt-4 text-3xl font-extrabold">
              <span>$49</span><span className="text-base font-medium text-slate-500">/mo</span>
            </p>
            <ul className="mt-4 space-y-2 text-sm">
      ...
      <footer className="border-t border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-10 text-sm flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <a href="/dashboard" className="hover:text-slate-900">Help</a>
          </nav>
        </div>
      </footer>
    </main>
